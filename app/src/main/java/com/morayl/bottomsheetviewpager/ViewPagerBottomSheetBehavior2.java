...
public class ViewPagerBottomSheetBehavior2<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public ViewPagerBottomSheetBehavior2(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        }
    ...
    private void calculateCollapsedOffset() {
        int peek = calculatePeekHeight();
            ...
            collapsedOffset = mParentHeight - peek;
    }

    private int calculatePeekHeight() {
        if (mPeekHeightAuto) {
            int desiredHeight = max(mPeekHeightMin, mParentHeight - mParentWidth * 9 / 16);
...
//                    }
    ...
    private void calculateHalfExpandedOffset() {
        this.halfExpandedOffset = (int) (mParentHeight * (1 - halfExpandedRatio));
    }
    ...
    private View getCurrentViewWithVP(ViewPager viewPager) {
        return BottomSheetVPHelper.getCurrentViewWithVP(viewPager);
    }
    ...
    /**
     * A utility function to get the {@link ViewPagerBottomSheetBehavior2} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link ViewPagerBottomSheetBehavior2}.
     * @return The {@link ViewPagerBottomSheetBehavior2} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> ViewPagerBottomSheetBehavior2<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof ViewPagerBottomSheetBehavior2)) {
            throw new IllegalArgumentException(
                    "The view is not associated with ViewPagerBottomSheetBehavior");
        }
        return (ViewPagerBottomSheetBehavior2<V>) behavior;
    }
